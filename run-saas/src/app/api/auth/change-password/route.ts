...
export async function POST(request: NextRequest) {
    try {
        ...
        let user: { id: string; email: string; password?: string; passwordHash?: string; firstName?: string } | null = null
        ...
        const currentHash = 'passwordHash' in user ? user.passwordHash : user.password
        if (!currentHash) {
            return NextResponse.json(
