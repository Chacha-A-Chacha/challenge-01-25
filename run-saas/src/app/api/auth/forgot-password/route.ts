...
export async function POST(request: NextRequest) {
    try {
        ...
        let user: { id: string; email: string; firstName?: string; surname?: string } | null = null
        let name = 'User'
        ...
        const resetTokenExpiry = new Date(Date.now() + EMAIL_CONFIG.RESET_TOKEN.EXPIRY_MINUTES * 60 * 1000)
