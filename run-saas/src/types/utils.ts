...
export type StudentWithSessions = EntityWithRelations<Student, {
  sessions: Session[]
  class: Class
}>

export type SessionWithStudents = EntityWithRelations<Session, {
  students: Student[]
...
export type TeacherWithCourse = EntityWithRelations<Teacher, {
  course?: Course
  headCourse?: Course
}>

export type CourseWithDetails = EntityWithRelations<Course, {
  headTeacher: Teacher
  teachers: Teacher[]
  classes: Class[]
  _count: {
...
export type ClassWithSessions = EntityWithRelations<Class, {
  sessions: Session[]
  students: Student[]
  course: Course
  _count: {
