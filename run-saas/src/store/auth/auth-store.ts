...
interface PasswordStore {
    ...
    setForgotPasswordField: (field: keyof Omit<ForgotPasswordState, 'isLoading' | 'error' | 'success'>, value: string) => void
    submitForgotPassword: () => Promise<boolean>
    resetForgotPassword: () => void

    // Reset Password
    resetPassword: ResetPasswordState
    setResetPasswordField: (field: keyof Omit<ResetPasswordState, 'isLoading' | 'error' | 'success'>, value: string) => void
    submitResetPassword: () => Promise<boolean>
    resetResetPassword: () => void

    // Change Password
    changePassword: ChangePasswordState
    setChangePasswordField: (field: keyof Omit<ChangePasswordState, 'isLoading' | 'error' | 'success'>, value: string) => void
...
export const usePasswordStore = create<PasswordStore>((set, get) => ({
    ...
    submitChangePassword: async () => {
        const { currentPassword, newPassword, confirmNewPassword } = get().changePassword
